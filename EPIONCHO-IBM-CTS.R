...
run.mod <- function(ABR=1000,delta.hz  = 0.1864987,delta.hinf = 0.002772749 , c.h = 0.004900419,
                        ...
                        a.H = 0.8, g = 0.0096, h=0.63, a.v = 0.39, num.comps.worm = 21, real.max.age = 80, N = 500, mean.age = 50,
                        int.L3 = 0.03, int.L2 = 0.03, int.L1 = 0.03, lambda.zero = 0.33, omeg = 0.59,
                        delta.vo = 0.0166, c.v = 0.0205, num.mf.comps = 21, DT = 2/366, int.worms=1, ss.wt = 2, num.ss = 2,
                        slope.kmf = 0.0478, int.kMf = 0.313, sex.rat = 0.5, nuone = 201.6189, nutwo = 207.7384, 
                        time.each.comp.worms = 1, time.each.comp.mf = 0.125, mu.w1 = 0.0975, mu.w2 = 6.01, fec.w.1 = 70, fec.w.2 = 0.72,
                        mu.mf1 = 1.09, mu.mf2 = 1.43,  sero.sensitivity.in = 0.8, mf.move.rate = 8.133333,
